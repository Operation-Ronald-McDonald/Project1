...
In other words, write down what kind of data you plan to work with, and what kinds of questions you'd like to ask of it. This constitutes your Project Proposal/Outline, and should include a sentence or two (something like this):
...
You will use your group's git repository readme.md file as a means to keep stakeholders up to date on your project to include: 
* Members of the Team
* Project proposal / outline (to include a hypothesis you will accept or reject)
* Data Sources
* Questions you will/have asked of the data (include why you asked them)
* Methodology (to include tools used in each step)* 
* Key findings and results (to include the statistical test used to accept or reject your project hypothesis)
